package com.example.client1.imagesetdemo;
...
public class CustomProgressDia extends ProgressDialog
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        aniClockAnimation = AnimationUtils.loadAnimation(context, R.anim.fadeout);
    ...
    {
        super.show();
        outerRingClock.setAnimation(clockAnimation);
